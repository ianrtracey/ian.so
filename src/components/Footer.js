...
export default () => (
<footer className="sans-serif pa4 pa5-l black-70 bt b--black-10">
  <section className="cf mb5">
    ...
    <div className="mb4 mb0-ns fl w-100 w-50-l" >
      ...
      <input placeholder="your-email@here.com" className="mw-100 w-100 w5-ns f5 input-reset ba b--black-20 pv3 ph4 border-box"/>
